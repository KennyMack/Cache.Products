using Cache.Products.Controllers;
...
namespace Cache.Products
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DbCacheContext>(options => options.UseSqlServer(Configuration["ConnectionStrings:DataBase"]));
            services.AddStackExchangeRedisCache(options => { options.Configuration = Configuration["ConnectionStrings:Redis"]; });

            services.AddScoped<IProductsDto, ProductsDto>();
            services.AddScoped<IProductsDto, ProductsDto>();
